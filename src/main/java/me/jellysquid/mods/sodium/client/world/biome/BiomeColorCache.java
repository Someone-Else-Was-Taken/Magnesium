...
public class BiomeColorCache {
    ...
    public BiomeColorCache(ColorResolver resolver, WorldSlice slice) {
        ...
        this.minX = origin.minBlockX() - (this.radius + MODEL_RADIUS);
        this.minY = origin.minBlockY() - (this.radius + MODEL_RADIUS);
        this.minZ = origin.minBlockZ() - (this.radius + MODEL_RADIUS);

        this.dim = 16 + ((this.radius + MODEL_RADIUS) * 2);

        this.blendedColorsMinX = origin.minBlockX() - MODEL_RADIUS;
        this.blendedColorsMinY = origin.minBlockY() - MODEL_RADIUS;
        this.blendedColorsMinZ = origin.minBlockZ() - MODEL_RADIUS;
