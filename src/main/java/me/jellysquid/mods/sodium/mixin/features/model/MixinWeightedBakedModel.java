...
public class MixinWeightedBakedModel {
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction face, Random random, net.minecraftforge.client.model.data.IModelData modelData) {
